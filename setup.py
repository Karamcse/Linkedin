...
opts = {
    'py2exe': { "includes" : ["sip", "PyQt4", "matplotlib"],
...
data_files = [(r'mpl-data', glob.glob(r'C:\Python27\Lib\site-packages\matplotlib\mpl-data\*.*')),
                  ...
                  ("selenium/webdriver/firefox",[r'C:\Python27\Lib\site-packages\selenium\webdriver\firefox\webdriver_prefs.json',r'C:\Python27\Lib\site-packages\selenium\webdriver\firefox\webdriver.xpi'])
]

# for console program use 'console = [{"script" : "scriptname.py"}]
setup(console=[{"script" : "Linkedinautomate.py"}], options=opts,   data_files=data_files)
